...
# ============================================
# STEP 1: Git - Check Status & Commit
# ============================================
...
if ($LASTEXITCODE -ne 0) {
    Write-Host "⚠️  No Railway project linked. Linking..." -ForegroundColor Yellow
    railway link
...
if (!$isLinked) {
    Write-Host "⚠️  No Vercel project linked. Will link to nexoai-flax..." -ForegroundColor Yellow
}
...
Write-Host "✓ CORS updated (backend will auto-restart)" -ForegroundColor Green
...
Write-Host ""
Write-Host "Re-deploy:" -ForegroundColor Yellow
Write-Host "  .\deploy-complete.ps1     # Full deployment" -ForegroundColor White
Write-Host "  .\update-frontend.ps1     # Frontend only" -ForegroundColor White
Write-Host ""
...
Write-Host "2. Test authentication & features" -ForegroundColor White
